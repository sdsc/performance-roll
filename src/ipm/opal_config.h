...
#define MCA_io_romio_COMPLETE_CONFIGURE_FLAGS " FROM_OMPI=yes CC='icc -std=gnu99' CFLAGS='-DNDEBUG -O3 -fPIC -finline-functions -fno-strict-aliasing -restrict -Qoption,cpp,--extended_float_types -pthread' CPPFLAGS='  -I/scratch/build/git/mpi-roll/BUILD/sdsc-openmpi_intel_ib-1.8.4/openmpi-1.8.4/opal/mca/hwloc/hwloc191/hwloc/include -I/scratch/build/git/mpi-roll/BUILD/sdsc-openmpi_intel_ib-1.8.4/openmpi-1.8.4/opal/mca/event/libevent2021/libevent -I/scratch/build/git/mpi-roll/BUILD/sdsc-openmpi_intel_ib-1.8.4/openmpi-1.8.4/opal/mca/event/libevent2021/libevent/include' FFLAGS='-O3 -fPIC ' LDFLAGS=' ' --enable-shared --enable-static  --prefix=/opt/openmpi/intel/ib --disable-aio"
...
#define OMPI_ALIGNMENT_FORTRAN_DOUBLE_COMPLEX 1
...
#define OMPI_BTL_VADER_HAVE_KNEM 1
...
#define OMPI_ENABLE_DYNAMIC_SL 1
...
#define OMPI_FC "ifort"

/* Absolutey path to the underlying Fortran compiler found by configure */
#define OMPI_FC_ABSOLUTE "/opt/intel/composer_xe_2013_sp1.2.144/bin/intel64/ifort"
...
#define OMPI_FORTRAN_IGNORE_TKR_PREDECL "!DEC$ ATTRIBUTES NO_ARG_CHECK ::"
...
/* The compiler $lower which OMPI was built with */
#define OPAL_BUILD_PLATFORM_COMPILER_FAMILYNAME INTEL

/* The compiler $lower which OMPI was built with */
#define OPAL_BUILD_PLATFORM_COMPILER_VERSION 1474737976

/* The compiler $lower which OMPI was built with */
#define OPAL_BUILD_PLATFORM_COMPILER_VERSION_STR 1400.20140120
...
#define OPAL_PACKAGE_STRING "Open MPI root@comet-devel.local Distribution"
...
#define WRAPPER_EXTRA_LIBS "-lm -ldl -lrt -losmcomp -libverbs -lrdmacm -lnl -lutil "
